...
import lush from '../assets/screen-lush.png';
import netflick from '../assets/screen-netflick.png';
import cursos from '../assets/screen-ecomcursos.png';
import mytinerary from '../assets/screen-mytineraries.png';
import ourbakery from '../assets/screen-ourbakery.png';
import weather from '../assets/screen-weather.png';



const Work = () => {
  return (
    <div name='work' className='w-full md:h-screen pt-24 text-[#1d3557]'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 text-[#eeeeee] border-[#d8fc37]'>
            Work
          </p>
          <p className='py-6 text-[#eeeeee]'>Check out some of my recent work</p>
        </div>
